...
public class HomePagePO {
	...
	@FindBy(xpath="//*[text()='Dave']") private WebElement dave;
	...
	public void setEventDetails(String sName,String sStartDate,String sStartTime,String sEndDate,String sEndTime) throws InterruptedException {
		eventNameTxt.clear();
		Thread.sleep(5000);
